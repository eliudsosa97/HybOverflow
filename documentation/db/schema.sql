...
-- Checkpoint 2: ERD Implementation
-- =========================================
...
1. Rendimiento en consultas frecuentes
2. Integridad referencial
3. Escalabilidad futura
4. Mantenimiento de datos históricos (soft deletes)

Consideraciones importantes:
- Usar soft deletes (is_active) en lugar de DELETE físico
- Los votos pueden ser negativos (downvotes)
- Las categorías son opcionales en preguntas
